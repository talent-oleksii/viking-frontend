    ...
    <>
      ...
      <main className="flex min-h-screen w-full flex-col items-center justify-center py-32">
        ...
        >
          ...
          <div className="flex items-center justify-center sm:hidden mt-[60px] flex-col">
            <img
              src="/images/12.jpg"
          ...
          <div className="flex justify-center items-center mt-3">
            <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="me-4">
            ...
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="ms-4">
