    ...
    <>
      ...
      <main className="flex min-h-screen w-full flex-col items-center justify-center py-32">
        ...
        >
          ...
          <motion.h1
            className="max-w-2xl mx-auto bg-gradient-to-br from-black to-stone-500 bg-clip-text text-center font-dm text-4xl sm:text-5xl font-extrabold sm:font-bold tracking-[-0.02em] text-transparent drop-shadow-sm md:text-7xl md:leading-[5rem] pb-[2px]"
            variants={FADE_DOWN_ANIMATION_VARIANTS}
          >
